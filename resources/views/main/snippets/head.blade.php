...
<!-- BEGIN: Custom CSS -->
<link rel="stylesheet" type="text/css" href="{{ asset('/sources/main/style.css') }}?v={{ time() }}">
<!-- END: Custom CSS -->
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-GXJHV98PET"></script>
<script>
